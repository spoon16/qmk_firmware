...
// #define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_SPOON16 // Sets the default mode, if none has been set
...
#define RGB_MATRIX_STARTUP_MODE RGB_MATRIX_CUSTOM_SPOON16_MAC
