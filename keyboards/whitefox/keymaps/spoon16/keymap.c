...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_DEFAULT] = KEYMAP( \
        ...
        KC_MEH,     KC_LALT,    KC_LGUI,    KC_SPCFN,   KC_LFN,     KC_NO,      NOKEY,      KC_LEFT,    KC_DOWN,    KC_RGHT \
    ),
    [L_FN] = KEYMAP( \
        ...
        __________, __________, __________, __________, __________, KC_LEAD,    __________, __________, __________, __________ \
    ),
};
